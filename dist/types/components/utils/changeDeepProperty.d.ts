 ...
 */
export declare const changeDeepProperty: <T extends Record<string, unknown>, P extends IDeepKeyof<T, Depth>, Depth extends 0 | 1 | 2 | 3 | 6 | 8 | 4 | 5 | 7 | 9 = 4>({ obj, propertyPath, value, }: {
    obj: T;
    propertyPath: P;
