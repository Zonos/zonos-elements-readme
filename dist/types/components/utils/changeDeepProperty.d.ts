 ...
 */
export declare const changeDeepProperty: <T extends Record<string, unknown>, P extends IDeepKeyof<T, Depth>, Depth extends 0 | 2 | 1 | 3 | 5 | 8 | 4 | 6 | 7 | 9 = 4>({ obj, propertyPath, value, }: {
    obj: T;
    propertyPath: P;
