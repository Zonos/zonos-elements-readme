 ...
 */
export declare const changeDeepPropertyAtIndex: <T extends object, P extends IDeepKeyofAtIndex<T, Depth>, Depth extends 0 | 1 | 2 | 6 | 8 | 3 | 4 | 5 | 7 | 9 = 4>({ index, obj, propertyPath, value, }: {
    index: number;
    obj: T;
    propertyPath: P;
